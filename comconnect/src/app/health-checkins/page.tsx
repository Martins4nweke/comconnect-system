...
export default function HealthCheckinsPage() {
  ...
  return (
    <PageShell>
      ...
      <Notice tone="info">
        Use this page to review submitted observations. High or urgent severity
        items should be reviewed and resolved from the table actions.
      </Notice>

      <div className="mt-4">
        <LargeTableClient config={tableConfigs.observations} />
      </div>
    </PageShell>
  );
}